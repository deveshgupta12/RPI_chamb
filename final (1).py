...
DEEP_SLEEP_ENABLED = True  # Enable aggressive power saving
...
def video_feed():
    ...
    global VIDEO_STREAM_ACTIVE, system_state
    ...
    try:
        ...
        # Consider shutting down camera if idle mode is active
        if system_state == SystemState.IDLE:
            shutdown_camera()
...
if __name__ == '__main__':
    ...
    # gunicorn -w 1 -b 0.0.0.0:5000 --threads 2 --timeout 120 --worker-class sync "final (1):app"
